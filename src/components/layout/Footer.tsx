  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Implementation Guides', href: '/tutorials' },
        { name: 'Product Demos', href: '/webinars' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                thousands of companies who trust Acme SaaS to streamline their operations and
                accelerate growth.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">500 Innovation Drive, Tech Hub 200</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get feature releases and industry insights. Unsubscribe anytime.
              </p>
            </div>
          </div>
