...
export default function Pricing() {
  ...
  const plans = [
    {
      name: 'Startup',
      description: 'Perfect for small businesses starting their SaaS journey',
    ...
    {
      name: 'Growth',
      description: 'Ideal for scaling businesses with advanced SaaS needs',
    ...
    {
      name: 'Enterprise',
      description: 'For large organizations requiring enterprise-grade SaaS',
      price: 'Custom',
      period: '',
      badge: 'White Glove',
      features: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Choose the perfect SaaS plan for your business growth. Enterprise-grade security, 99.99%
            uptime SLA, and seamless scalability included in every tier.
          </p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            We build tailored SaaS platforms for enterprises with unique requirements. Let's discuss
            your specific business needs and technical specifications.
          </p>
